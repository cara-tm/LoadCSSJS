...
If you don't need javascript loader, use the LoadCSS.min.js very light version of 0.515 kb instead. Same usage, but the "type" (second) attribut isn't supported (i.e.: LoadCSSJS("../css/main.min.css", "only screen");). 
